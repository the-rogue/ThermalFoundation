...
import cofh.repack.codechicken.lib.render.pipeline.IVertexSource;
import cofh.repack.codechicken.lib.render.pipeline.VertexAttribute;
import cofh.repack.codechicken.lib.render.pipeline.attribute.AttributeKey;
import cofh.repack.codechicken.lib.render.pipeline.attribute.AttributeKey.AttributeKeyRegistry;
import cofh.repack.codechicken.lib.render.pipeline.attribute.ColourAttribute;
import cofh.repack.codechicken.lib.render.pipeline.attribute.LightCoordAttribute;
import cofh.repack.codechicken.lib.render.pipeline.attribute.LightingAttribute;
import cofh.repack.codechicken.lib.render.pipeline.attribute.NormalAttribute;
import cofh.repack.codechicken.lib.util.ArrayUtils;
import cofh.repack.codechicken.lib.util.Copyable;
import cofh.repack.codechicken.lib.util.VectorUtils;
...
import cofh.repack.codechicken.lib.vec.Vertex5;
import cofh.repack.codechicken.lib.vec.uv.UV;
import cofh.repack.codechicken.lib.vec.uv.UVTransformation;
import cofh.repack.codechicken.lib.vec.uv.UVTranslation;
