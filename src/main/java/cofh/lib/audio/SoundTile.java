...
public class SoundTile extends SoundBase implements ITickableSound {
	...
	public SoundTile(ISoundSource source, String sound, float volume, float pitch, boolean repeat, int repeatDelay, double x, double y, double z, SoundCategory category) {

		this(source, sound, volume, pitch, repeat, repeatDelay, x, y, z, AttenuationType.LINEAR, category);
	}
	...
	public SoundTile(ISoundSource source, String sound, float volume, float pitch, boolean repeat, int repeatDelay, double x, double y, double z,
			AttenuationType attenuation, SoundCategory category) {

		this(source, new ResourceLocation(sound), volume, pitch, repeat, repeatDelay, x, y, z, attenuation, category);
	}

	public SoundTile(ISoundSource source, ResourceLocation sound, float volume, float pitch, boolean repeat, int repeatDelay, double x, double y, double z, SoundCategory category) {
	...
	public SoundTile(ISoundSource source, ResourceLocation sound, float volume, float pitch, boolean repeat, int repeatDelay, double x, double y, double z,
		...
		super(sound, volume, pitch, repeat, repeatDelay, x, y, z, attenuation, category);
		this.source = source;
